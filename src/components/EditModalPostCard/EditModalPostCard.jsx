...
const EditModalPostCard = ({
  ...
  const [selectedImage, setSelectedImage] = useState(content[1]);
  const [postStory, setPostStory] = useState(content[0]);
  ...
  const postContent = [postStory, selectedImage,_id];
      ...
      <div className="flex items-center mt-4">
        ...
        <div className="w-full flex items-center justify-end gap-3">
          ...
          <button
            ...
            className={` text-white w-30 px-3 py-1 rounded-sm hover:opacity-90 ${
              !isButtonDisabled
                ? `bg-[#378fe9]`
...
export default EditModalPostCard;
